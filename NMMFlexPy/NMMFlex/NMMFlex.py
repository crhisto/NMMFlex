...
# TODO: Implement noise treatment for NMMFlex based on the approach described
#  in this article:
...
class NMMFlex:
    ...
    def run_deconvolution_multiple(self, x_matrix, y_matrix, z_matrix, k,
                                   ...
                                   verbose=True):
        """
        Function that runs the NMMFlex with three matrices as input. You can
    ...
    def _initialize_matrix(self, size_rows, size_columns,
        ...
        if initialized_matrix is not None:
            ...
            if method == 'random_based.uniform':
                ...
                # https://numpy.org/doc/stable/reference/random/generated/numpy.random.rand.html #noqa
                ...
                # https://numpy.org/doc/stable/reference/random/generated/numpy.random.power.html #noqa
...
# the general behaviour of the grid.
class grid_search_parallelized_async:
    ...
    def grid_search_parallelized_alpha_beta(self,
        ...
        # In case of some combinations of fixed matrices that get the
        # (gamma, alpha, beta) = 0
        gamma, alpha, beta = NMMFlex.check_fixed_matrices_gamma_alpha_beta(
            fixed_w=fixed_w, fixed_h=fixed_h,
            fixed_a=fixed_a, fixed_b=fixed_b,
